	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-3 column">
				...
				<div>
					<a data-toggle="modal" href="#updateMerchant" class="btn btn-warning" role="button"
				...
				<div style="margin: 20px auto auto auto;">
					<ul class="list-group">
						<li class="list-group-item">
							<span class="label label-success">累计收入</span>&nbsp;&nbsp;
							${currentMerchant.sum}
						</li>
						<li class="list-group-item">
							<span class="label label-primary">真实姓名</span>&nbsp;&nbsp;
							${currentMerchant.merchantRealName}
						</li>
						<li class="list-group-item">
							<span class="label label-primary">身份证号</span>&nbsp;&nbsp;
							${currentMerchant.merchantIdCard}
						</li>
						<li class="list-group-item">
							<span class="label label-primary">联系方式</span>&nbsp;&nbsp;
							${currentMerchant.merchantTel}
						</li>
					</ul>
				</div>
				...
				<div>
					<ul class="nav nav-pills nav-stacked" role="tablist">
						<li role="presentation">
							<a href="${pageContext.request.contextPath }/orderList?id=${currentMerchant.merchantId}&status=0&flag=flase&page=1" class="btn btn-default">
								待处理<span class="badge">42</span></a></li>
						<li role="presentation">
							<a href="${pageContext.request.contextPath }/orderList?id=${currentMerchant.merchantId}&status=1&flag=flase&page=1" class="btn btn-default">
								等待收货<span class="badge">42</span></a></li>
						<li role="presentation">
							<a href="${pageContext.request.contextPath }/orderList?id=${currentMerchant.merchantId}&status=2&flag=flase&page=1" class="btn btn-default">
								已完成</a></li>
					</ul>
				</div>
				...
				<div>
					<ul class="nav nav-pills nav-stacked" role="tablist">
						<li role="presentation">
							<a href="${pageContext.request.contextPath }/alterFood?action=selectList&merchantId=${currentMerchant.merchantId}" class="btn btn-default">
								已发布<span class="badge">42</span></a></li>
						<li role="presentation">
							<a href="${pageContext.request.contextPath }/alterFood?action=showAdd" class="btn btn-default">
								添加食品<span class="badge">42</span></a></li>
					</ul>
				</div>
...
<!-- 修改商家个人信息模态框，本人很爱模态框 -->
<div class="modal fade" id="updateMerchant" tabindex="-1" 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
					...
					<form class="form-horizontal" role="form" id="updateMerchantForm"  method="post"
							action=" ">
					...
					<div class="form-group">
						<label for="merchantIdCard" class="col-sm-2 control-label">学号</label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="merchantRealName"
								id="merchantRealName" value="${currentMerchant.merchantRealName}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="merchantTel" id="merchantTel"
								value="${currentMerchant.merchantTel}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="description" id="description"
								value="${currentMerchant.description}">
						</div>
					</div>
